...
class MatmulPlugin : public nvinfer1::IPluginV2IOExt {
 public:
  ...
  nvinfer1::IPluginV2IOExt* clone() const TRT_NOEXCEPT override {
    std::cout << "clone(): from_this: " << this << std::endl;
    MatmulPlugin* ptr =
    ...
    std::cout << "clone(): to_this: " << ptr << std::endl;
    return ptr;
  }
  ...
  */
  int initialize() TRT_NOEXCEPT {
    std::cout << "initialize(): this: " << this << std::endl;
    return 0;
  }
  ...
  void destroy() TRT_NOEXCEPT override {
    std::cout << "destroy(): this: " << this << std::endl;
    delete this;
  }
...
class MatmulPluginDynamic : public DynamicPluginTensorRT {
 public:
  ...
  nvinfer1::IPluginV2DynamicExt* clone() const TRT_NOEXCEPT override {
    std::cout << "clone(): this: " << this << std::endl;
    ...
    ptr->Ctransform_ = Ctransform_;
    ptr->type_ = type_;
    std::cout << "clone(): ptr: " << ptr << std::endl;
    return ptr;
  }
